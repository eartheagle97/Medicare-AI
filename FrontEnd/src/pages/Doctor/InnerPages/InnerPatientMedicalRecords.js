...
import InnerSubPatientMedicalRecords from './InnerSubPatientMedicalRecords';

function InnerPatientMedicalRecords() {
    const { id } = useParams()
            ...
            <div id="kt_content_container" className="container-xxl">
                <div className="card mb-5 mb-xl-10">
                    <div className="card-body pt-9 pb-0">
                        ...
                        <InnerPatientLinks active={'MedicalRecords'} />
                    </div>
                </div>
                
                <InnerSubPatientMedicalRecords />
            </div>
        </div >
    )
}

export default InnerPatientMedicalRecords